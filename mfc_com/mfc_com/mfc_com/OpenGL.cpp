...
void COpenGL::RenderGLScene(float q0,float q1,float q2,float q3,float G0_PitchN,float G0_RollN,float Hxn,float Hyn,int RoolSN,int PitchSN,int YawSN,
	                        int RoolN,int PitchN,int YawN,static GLfloat   xrot,static GLfloat   yrot,static GLfloat   zrot,
							static GLfloat   xacc,static GLfloat   yacc,static GLfloat   zacc,
...
//绘制世界坐标原点
 ...
 /*************绘制网格线*************/
   ...
   {
   glVertex3f(0,0,0);
   glVertex3f(xacc*1,yacc*1,zacc*1); 
   }
    glEnd();
	glPopMatrix();//储存当前视图矩阵
 */
