...
public:
 ...
 virtual void RenderGLScene(float q0,float q1,float q2,float q3,float G0_PitchN,float G0_RollN,float Hxn,float Hyn,
	                        int RoolSN,int PitchSN,int YawSN,int Rool,int Pitch, int Yaw,
							GLfloat xrot,GLfloat yrot,GLfloat zrot,
							GLfloat xacc,GLfloat yacc,GLfloat zacc,
